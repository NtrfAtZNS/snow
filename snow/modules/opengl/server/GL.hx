package snow.modules.opengl.server;

#if snow_dedicated_server
...
typedef GLActiveInfo                = Null< Int >;
typedef GLBuffer                    = Null< Int >;
typedef GLContextAttributes         = Null< Int >;
typedef GLFramebuffer               = Null< Int >;
typedef GLProgram                   = Null< Int >;
typedef GLRenderbuffer              = Null< Int >;
typedef GLShader                    = Null< Int >;
typedef GLTexture                   = Null< Int >;
typedef GLUniformLocation           = Null< Int >;
typedef GLShaderPrecisionFormat     = Null< Int >;
...
//spec
    ...
    inline public static function checkFramebufferStatus(target:Int):Int return 0;
    ...
    inline public static function createBuffer():GLBuffer return 1;
    inline public static function createFramebuffer():GLFramebuffer return 1;
    inline public static function createProgram():GLProgram return 1;
    inline public static function createRenderbuffer():GLRenderbuffer return 1;
    inline public static function createShader(type:Int):GLShader return 1;
    inline public static function createTexture():GLTexture return 1;
    ...
    inline public static function getActiveAttrib(program:GLProgram, index:Int):GLActiveInfo return 0;
    inline public static function getActiveUniform(program:GLProgram, index:Int):GLActiveInfo return 0;
    inline public static function getAttachedShaders(program:GLProgram):Array<GLShader> return [];
    inline public static function getAttribLocation(program:GLProgram, name:String):Int return 0;
    inline public static function getBufferParameter(target:Int, pname:Int):Dynamic return null;
    inline public static function getContextAttributes():GLContextAttributes return null;
    inline public static function getError():Int return NO_ERROR;
    inline public static function getExtension(name:String):Dynamic return null;
    inline public static function getFramebufferAttachmentParameter(target:Int, attachment:Int, pname:Int):Dynamic return null;
    inline public static function getParameter(pname:Int):Dynamic return null;
    inline public static function getProgramInfoLog(program:GLProgram):String return "";
    inline public static function getProgramParameter(program:GLProgram, pname:Int):Int return 0;
    inline public static function getRenderbufferParameter(target:Int, pname:Int):Dynamic return false;
    inline public static function getShaderInfoLog(shader:GLShader):String return "";
    inline public static function getShaderParameter(shader:GLShader, pname:Int):Int return 0;
    inline public static function getShaderPrecisionFormat(shadertype:Int, precisiontype:Int) : GLShaderPrecisionFormat return 0;
    inline public static function getShaderSource(shader:GLShader):String return "";
    inline public static function getSupportedExtensions() : Array<String> return [];
    inline public static function getTexParameter(target:Int, pname:Int):Dynamic return null;
    inline public static function getUniform(program:GLProgram, location:GLUniformLocation):Dynamic return null;
    inline public static function getUniformLocation(program:GLProgram, name:String):GLUniformLocation return 0;
    inline public static function getVertexAttrib(index:Int, pname:Int):Dynamic return null;
    inline public static function getVertexAttribOffset(index:Int, pname:Int):Int return 0;
    inline public static function hint(target:Int, mode:Int):Void {}
    inline public static function isBuffer(buffer:GLBuffer):Bool return true;

    // This is non-static
    // public function isContextLost():Bool { return false; }

    inline public static function isEnabled(cap:Int):Bool return true;
    inline public static function isFramebuffer(framebuffer:GLFramebuffer):Bool return true;
    inline public static function isProgram(program:GLProgram):Bool return true;
    inline public static function isRenderbuffer(renderbuffer:GLRenderbuffer):Bool return true;
    inline public static function isShader(shader:GLShader):Bool return true;
    inline public static function isTexture(texture:GLTexture):Bool return true;
...
// getters/setters
    ...
    static function get_version():Int { return 0; }
